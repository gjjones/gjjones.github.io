...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsApp = __webpack_require__(177);

	var _componentsApp2 = _interopRequireDefault(_componentsApp);

	var _redux = __webpack_require__(166);

	var _reducersCoffee = __webpack_require__(181);

	var _reducersCoffee2 = _interopRequireDefault(_reducersCoffee);

	var store = (0, _redux.createStore)(_reducersCoffee2['default']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsActions = __webpack_require__(178);

	var _WeightInput = __webpack_require__(179);

	var _WeightInput2 = _interopRequireDefault(_WeightInput);

	var _CoffeeSummary = __webpack_require__(180);

	var _CoffeeSummary2 = _interopRequireDefault(_CoffeeSummary);
	...
	var App = (function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'h2',
	          null,
	          _react2['default'].createElement(_WeightInput2['default'], {
	            weight: this.props.brewCoffeeWeight,
	            onChange: this.updateBrewCoffeeWeight.bind(this)
	          }),
	          'g of coffee grounds'
	        ),
	        _react2['default'].createElement(_CoffeeSummary2['default'], {
	    ...
	    key: 'updateBrewCoffeeWeight',
	    value: function updateBrewCoffeeWeight(weight) {
	      this.props.dispatch((0, _actionsActions.updateWeight)(weight));
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeightInput = (function (_Component) {
	  _inherits(WeightInput, _Component);

	  function WeightInput(props) {
	    _classCallCheck(this, WeightInput);

	    _get(Object.getPrototypeOf(WeightInput.prototype), "constructor", this).call(this, props);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CoffeeSummary = (function (_Component) {
	  _inherits(CoffeeSummary, _Component);

	  function CoffeeSummary() {
	    _classCallCheck(this, CoffeeSummary);

	    _get(Object.getPrototypeOf(CoffeeSummary.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(CoffeeSummary, [{
	    key: 'render',
	    value: function render() {
	      var brewWaterVolume = Math.ceil(this.props.brewWaterVolume),
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          null,
	          'at ',
	          this.props.brewCoffeeParts,
	          ':',
	          this.props.brewWaterParts,
	          ' coffee to water'
	        ),
	        _react2['default'].createElement(
	          'p',
	        ...
	        _react2['default'].createElement(
	          ...
	          null,
	          'which diluted at ',
	          this.props.yieldConcentrateParts,
	          ':',
	          this.props.yieldWaterParts,
	          ' concetrate to water'
	        ),
	        _react2['default'].createElement(
	          'p',
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = function (state, action) {
	  ...
	  switch (action.type) {
	    case _actionsActions.UPDATE_WEIGHT:
	      var brewCoffeeWeight = action.value;
	      var brewWaterVolume = brewCoffeeWeight / (state.brewCoffeeParts / state.brewWaterParts);
	      var yieldVolume = brewWaterVolume * (state.yieldConcentrateParts / state.yieldWaterParts);
	      var afterDilutionVolume = yieldVolume * 3;
	      return _extends({}, state, {
	        brewCoffeeWeight: brewCoffeeWeight,
	        brewWaterVolume: brewWaterVolume,
	        yieldVolume: yieldVolume,
	        afterDilutionVolume: afterDilutionVolume
	      });
	    default:
	      return state;
	  }
